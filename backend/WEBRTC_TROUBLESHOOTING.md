...
2. **Local Network Setup**
   ...
   - Use the server's local network IP (e.g., 172.20.10.2)
...
const WS_URL = "ws://172.20.10.2:8080/ws";
```
...
```bash
PUBLIC_HOST=172.20.10.2  # Use your server's local IP
PORT=8080
DEBUG=true
