...
2. **Local Network Setup**
   ...
   - Use the server's local network IP (e.g., 172.20.10.5)
...
```javascript
const API_URL = "http://172.20.10.5:8080";
...
```bash
PUBLIC_HOST=172.20.10.5  # Use your server's local IP
PORT=8080
DEBUG=true
...
```javascript
const config = {
  apiUrl: "http://172.20.10.5:8080",
  wsUrl: "ws://172.20.10.5:8080/ws",
  // ... other config
};
```
